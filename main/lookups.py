...
from main.utils import get_worst_csq, get_vep_csq_category
...
def get_variants(search_key: str, search_value: str) -> list:
    ...
    def _format_hgvs(hgvs_str):
        ...
        for hgvs in hgvs_str.split('&'):
            # Format synonymous variants HGVSp.
    ...
    for db_variant in db_variants:
        ...
        variant = {
            ...
            'consequence': get_worst_csq(
                db_variant.consequence, display_term=True
            ),
            'consequence_category': get_vep_csq_category(
