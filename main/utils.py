...
# VEP conseqeunces terms AND "Ter" AA in HGVSp.
...
def get_vep_csq_category(csq: str, hgvs_p: str) -> str:
    """
    Return variant vep consequence category based on its 
    vep consequence term and HGVSp notation.
